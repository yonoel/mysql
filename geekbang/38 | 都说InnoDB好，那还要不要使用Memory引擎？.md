...
![](./image/图%203%20表%20t1%20的数据组织.jpg)
...
![](./image/图%204%20表%20t1%20的数据组织%20--%20增加%20B-Tree%20索引.jpg)

新增的这个 B-Tree 索引你看着就眼熟了，这跟 InnoDB 的 b+ 树索引组织形式类似。

作为对比，你可以看一下这下面这两个语句的输出：

![](image/图%205%20使用%20B-Tree%20和%20hash%20索引查询返回结果对比.png)
